...
Besides contributing to the codebase, as a developer you can have a little bit
more power than a regular user. There are additional features both on the 
front-end and on the back-end that are only accessible to developers.
