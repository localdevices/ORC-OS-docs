...
# Vertical distance arrows from each datum to the water level
...
for datum_z, arrow_x, annotation, color in zip(datum_levels, arrow_x_positions, arrow_annotations, colors):
    ...
    # Put a centered label on each vertical arrow.
...
ax.text(gauge_x_1, gauge1_top + 0.1, "Staff gauge", ha="center", fontsize=10,
