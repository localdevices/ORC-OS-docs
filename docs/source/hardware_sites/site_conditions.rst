...
4. A safe location from any surrounding environmental threads, including but not limited to floods, vandalism, wildlife
   ...
   Also consider your own safety while installing, before going into the field.

.. note::

   If under high flow conditions, you do not see the entire width, the flow will still be estimated. ORC-OS has
   routines that use the existing observed surface velocities, combined with the cross section profile to estimate
   velocities in areas on the cross section that are beyond the field of view of the camera. Make sure that you always
   measure an as complete as possible cross section from left to right bank or natural levee, even if part of that
   cross section is not visible in the camera's field of view.
